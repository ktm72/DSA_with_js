class Heap {
  ...
  insert(value) {
    ...
    while (
      ...
      this.compare(this.data[lastIndex], this.data[Math.floor(lastIndex / 2)]) >
        0
    ) {
  ...
  //This returns a positive number if a is greater than b.
  //Here meaing of being greater depends on the type of heap.
  //For max heap it will return positive number if a>b and for min heap it will return positive number if a<b .
  compare(a, b) {
    if (this.type === "min") {
      return b - a;
    } else {
